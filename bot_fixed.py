...
DEFAULT_BOT_CONFIG = {
    ...
    "ban_durations_seconds": {"normal_user": 600, "premium_user": 30},
    ...
    "temp_ban_duration_seconds": {"normal_user": 600, "premium_user": 300},
...
def check_and_ban_user(username: str, user_id_for_premium_check: int = None, unban: bool = False) -> bool:
    ...
    if len(user_requests[username]) >= request_limit:
...
async def admin_transfer_stats(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [
            ...
            InlineKeyboardButton("👥 View Members", callback_data="admin_view_all_members")
        ],
        [InlineKeyboardButton("⬅️ Back to Admin Panel", callback_data="admin_panel_main")]
    ]
    ...
    try:
        ...
        # ADD THIS BLOCK IN admin_callback_router BEFORE THE FINAL "else" CHECK
            ...
            reply_markup = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("Unban User", callback_data="admin_users_unban")],
            ...
            message_text = f"Enter username_or_id to ban.\nOr /cancel_admin"
...
async def handle_admin_message_input(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # ADD THESE BLOCKS IN handle_admin_message_input AFTER existing state handlers
        ...
        if not text_input:
            ...
            op_successful = check_and_ban_user(target_username_found, user_id_for_premium_check=int(target_user_id_found) if target_user_id_found else None, unban=is_unban)
        ...
        if not text_input:
            ...
            try:
                ...
                if target_user_id_found:
                    if update_user_premium_status(target_user_id_found, target_username_for_update, "lifetime", days_override=days):
